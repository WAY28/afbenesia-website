        ...
        <footer className="bg-dark text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
                ...
                <div className="sm:col-span-2 lg:col-span-2">
                    ...
                    <a href={WA_URL} target="_blank" rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 bg-[#25D366] text-white px-5 py-2.5 rounded-xl font-bold text-sm hover:bg-[#22c55e] transition-colors">
            ...
            <div className="border-t border-white/10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-2">
                    <p className="text-white/35 text-xs">© 2026 PT. Afbe Cahaya Kreatif. All Rights Reserved.</p>
                    <p className="text-white/25 text-xs">Humanized AI · Indonesia</p>
                </div>
            </div>
        </footer>
    );
